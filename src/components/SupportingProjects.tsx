    ...
    <section className="section" id="projects">
      <div className="max-w-7xl mx-auto">
        ...
        <h2 className={`section-title ${fadeClass}`}>
          Supporting<br /><span className="stroke">projects.</span>
        </h2>
        <p className={`section-desc ${fadeClass}`}>
          Projects I've contributed to as part of collaborative teams, building real-world solutions.
        </p>
        <div className={`pc-grid ${fadeClass}`}>
          {suppotingprojectsData.map(p => (
            <ProjectCard
              key={p.id}
              project={p}
