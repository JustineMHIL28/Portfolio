// src/components/SupportingProjects.tsx
    ...
    <section id="projects" className="py-24 relative overflow-hidden">
      <div className="container mx-auto px-4">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="mb-16">
          <span className="text-green-400 font-mono text-sm uppercase tracking-wider">Collaborative Work</span>
          <h2 className="text-xl md:text-5xl font-bold mt-4 mb-6 tracking-wide">Supporting Projects</h2>
          <p className="text-xl text-muted-foreground max-w-3xl">
            Here are some projects I've contributed to as part of collaborative teams. Each project showcases my ability to work effectively with others in building functional, efficient, and user-friendly applications.
          </p>
        </motion.div>
              ...
              <div className="w-full lg:w-[40%] flex-1 lg:flex-none lg:h-full flex flex-col overflow-y-auto border-border">
                ...
                {selectedProjectData.link && (
                  <div className="flex flex-col gap-2 px-6 py-5 border-border shrink-0">
                    <Button className="w-full bg-green-500 hover:bg-green-600 text-black font-bold rounded-xl py-4" onClick={() => window.open(selectedProjectData.link, '_blank')}>
