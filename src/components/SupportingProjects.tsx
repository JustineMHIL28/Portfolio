      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-base sm:text-xl text-muted-foreground max-w-3xl">
            Here are some projects I've contributed to as part of collaborative teams. Each project
            showcases my ability to work effectively with others in building functional, efficient,
            and user-friendly applications.
          </p>
        </motion.div>

        {/* Mobile: 85vw cards for peek-ahead effect | md/lg: multi-col */}
